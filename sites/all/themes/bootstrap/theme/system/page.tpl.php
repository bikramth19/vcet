...
<header id="navbar" role="banner" class="<?php print $navbar_classes; ?>">
  <div class="container">
    ...
    <?php endif; ?>
      ...
      <div class="col-sm-4 secondary_menu">
  ...
  <div class="row">
    ...
    <?php endif; ?>
      ...
      <div class="preface container">
        <div class="col-sm-2 preface_one">
          <?php print render($page['preface_one']); ?>
        </div>
        <div class="col-sm-2 preface_two">
          <?php print render($page['preface_two']); ?>
        </div>
        <div class="col-sm-2 preface_three">
          <?php print render($page['preface_three']); ?>
        </div>
        <div class="col-sm-3 preface_four">
          <?php print render($page['preface_four']); ?>
        </div>
        <div class="col-sm-3 preface_five">
          <?php print render($page['preface_five']); ?>
        </div>
      </div>
